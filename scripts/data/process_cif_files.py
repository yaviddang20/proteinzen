...
from proteinzen.data.io import utils as du, parsers, errors, mmcif
...
parser.add_argument(
    '--ignore-resolution',
    help='Whether ignore resolution as a filtering criteria',
    default=False,
    action='store_true'
)
parser.add_argument(
