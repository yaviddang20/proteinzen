python train.py \
    ...
    hydra.run.dir="/datastor1/dy4652/proteinzen/outputs/geom_og/train" \
    'experiment.warm_start="/datastor1/dy4652/proteinzen/outputs/geom_og/train/lightning_logs/version_1/checkpoints/last.ckpt"'
