...
import torch
from ligbinddiff.utils.openfold import feats, rigid_utils as ru
from ligbinddiff.data.openfold import data_transforms, residue_constants
...
def transrotpsi_to_atom37(transrotpsi_traj, res_mask, impute_oxy=True):
    ...
    for trans, rots, psis in transrotpsi_traj:
        rigids = Rigid(
