...
from ligbinddiff.diffusion.noisers.so3_utils import rotation_vector_from_matrix
from ligbinddiff.diffusion.noisers.utils import rotvec_to_quat
...
class OneParamPairwiseEquilibrate(nn.Module):
    ...
    def equilibrate(self, rigids, pairwise_transforms, pairwise_weights, edge_index):
        ...
        rotvecs = rotation_vector_from_matrix(rots.get_rot_mats())
