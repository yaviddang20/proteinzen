...
from ligbinddiff.model.denoiser.bb.frames import GraphIpaFrameDenoiser, PSAEBFrameDenoiser, GraphIpmpFrameDenoiser, HybridSO3FrameDenoiser, SO3FrameDenoiser
...
class IPMPFrameDiff(nn.Module):
    def __init__(self,
        ...
        self.denoiser = GraphIpmpFrameDenoiser(
            c_s=c_s,
            c_z=c_z,
            c_hidden=c_hidden,
            num_pts=num_pts,
...
class HybridSO3FrameDiff(nn.Module):
    def __init__(self,
                 se3_noiser,
                 c_s=128,
                 c_v=16,
