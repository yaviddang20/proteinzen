...
class DefaultSE3Conf:
    diffuse_rot = True
    diffuse_trans = True
    so3 = so3_diffuser.DefaultSO3Conf()
    r3 = r3_diffuser.DefaultR3Conf()
...
class SE3Diffuser:
    ...
    def calc_rot_score2(self, rots_t, rots_0, t, batch):
        rots_0_inv = rots_0.invert()
        quats_0_inv = rots_0_inv.get_quats()
        quats_t = rots_t.get_quats()
        quats_0t = ru.quat_multiply(quats_0_inv, quats_t)
        rotvec_0t = du.quat_to_rotvec(quats_0t)
        return self._so3_diffuser.torch_score2(rotvec_0t, t, batch)
