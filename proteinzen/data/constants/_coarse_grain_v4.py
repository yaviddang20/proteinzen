...
# changes since v2
# P frame now centered on CD (to address confusion with K and D)
# R frame 2 now constructed to have (roughly) the same rotation as frame 3
# C now has the same frames as S
# manually set dummy frame for Y to CG
