...
from proteinzen.data.constants import _coarse_grain_v8 as cg_v8
...
def atom37_to_cg_frames(protein, eps=1e-8, cg_version=2):
    if cg_version == 2:
        ...
        raise ValueError(f"unable to find cg version {cg_version}, available versions are [2, 3, 4, 5, 6, 7, 8]")
    aatype = protein["aatype"]
    all_atom_positions = protein["all_atom_positions"]
    all_atom_mask = protein["all_atom_mask"]
