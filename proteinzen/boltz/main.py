...
from proteinzen.boltz.data.module.inference import BoltzInferenceDataModule
from proteinzen.boltz.data.module.inferencev2 import Boltz2InferenceDataModule
from proteinzen.boltz.data.mol import load_canonicals
from proteinzen.boltz.data.msa.mmseqs2 import run_mmseqs2
from proteinzen.boltz.data.parse.a3m import parse_a3m
from proteinzen.boltz.data.parse.csv import parse_csv
from proteinzen.boltz.data.parse.fasta import parse_fasta
from proteinzen.boltz.data.parse.yaml import parse_yaml
from proteinzen.boltz.data.types import MSA, Manifest, Record
from proteinzen.boltz.data.write.writer import BoltzAffinityWriter, BoltzWriter
from proteinzen.boltz.model.models.boltz1 import Boltz1
from proteinzen.boltz.model.models.boltz2 import Boltz2

CCD_URL = "https://huggingface.co/boltz-community/boltz-1/resolve/main/ccd.pkl"
MOL_URL = "https://huggingface.co/boltz-community/boltz-2/resolve/main/mols.tar"

BOLTZ1_URL_WITH_FALLBACK = [
    "https://model-gateway.proteinzen.boltz.bio/boltz1_conf.ckpt",
    "https://huggingface.co/boltz-community/boltz-1/resolve/main/boltz1_conf.ckpt",
]

BOLTZ2_URL_WITH_FALLBACK = [
    "https://model-gateway.proteinzen.boltz.bio/boltz2_conf.ckpt",
    "https://huggingface.co/boltz-community/boltz-2/resolve/main/boltz2_conf.ckpt",
]

BOLTZ2_AFFINITY_URL_WITH_FALLBACK = [
    "https://model-gateway.proteinzen.boltz.bio/boltz2_aff.ckpt",
...
def predict(  # noqa: C901, PLR0915, PLR0912
    ...
    """Run predictions with proteinzen.boltz."""
