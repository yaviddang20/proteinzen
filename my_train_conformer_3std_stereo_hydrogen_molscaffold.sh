...
python ${REPO_ROOT}/train.py \
    ...
    hydra.run.dir="'${REPO_ROOT}/outputs/geom_identityRot_256_conformer_3std_stereo_hydrogen_molscaffold_${ACCUM}/train'" \
    experiment.lightning.max_epochs=-1 \
    model.use_bond_rotation=false \
    experiment.lightning.accumulate_grad_batches=${ACCUM} \
